...
public class GenerationTypeIdentityApplication implements CommandLineRunner {

	@Autowired
	private EmployeeService employeeService;
	
	public static void main(String[] args) {
		SpringApplication.run(GenerationTypeIdentityApplication.class, args);
	}
	...
	{
		Employee employee = new Employee("shivani","ingole","shivani123@gmail.com",new Date());
